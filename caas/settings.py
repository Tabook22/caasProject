...
SECRET_KEY = '&^w^aly7np=+@mr=ixfv53vw0*nqp-pec+yel=jr2v#^zupk54'
...
STATIC_ROOT = os.path.join(BASE_DIR,'staticfiles') #This generates the directory where files static files are placed when you run ./manage.py collectstatic
